...
import { PabxPcsAddressComponent } from './pabx-pcsAddress.component';
import { CommonModule } from '@angular/common';
import { Ng2PaginationModule } from 'ng2-pagination';
// routes
export const ROUTES: Routes = [
  { path: '', component: PabxPcsAddressComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxPcsAddressComponent,
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxPcsAddressModule {}