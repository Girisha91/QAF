...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxUserAllNodesComponent } from './pabx-user_allNodes.component';
import { CommonModule } from '@angular/common';
import { Ng2PaginationModule } from 'ng2-pagination';
// routes
export const ROUTES: Routes = [
  { path: '', component: PabxUserAllNodesComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxUserAllNodesComponent
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxUserAllNodesModule {}