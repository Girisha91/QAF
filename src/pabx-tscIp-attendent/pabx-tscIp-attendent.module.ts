...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxTscIpAttendentComponent } from './pabx-tscIp-attendent.component';
import { CommonModule } from '@angular/common';
import { Ng2PaginationModule } from 'ng2-pagination';
// routes
export const ROUTES: Routes = [
  { path: '', component:PabxTscIpAttendentComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxTscIpAttendentComponent
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxTscIpAttendentModule {}