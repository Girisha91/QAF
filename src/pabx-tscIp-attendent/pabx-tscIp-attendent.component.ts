  ...
  @Component({
    moduleId: module.id,
    selector: 'app-pabx-tscIp-attendent',
    templateUrl: './pabx-tscIp-attendent.component.html',
    styleUrls: [('./pabx-tscIp-attendent.component.css').toString()]
  })
  export class PabxTscIpAttendentComponent {
  ...
  public OnSubmit(formValue: any) {
    ...
    body.append('action', "tsc_ip_attendent");
  ...
  loadData() {
    this.searchKeyArray = [{"item":"Node","label":"Node"},{"item":"Attendant","label":"Attendant"},{"item":"Attendant_sets","label":"Attendant sets"},{"item":"Directory_Number","label":"Directory Number"},{"item":"Set_Type","label":"Set Type"},{"item":"Terminal_Ethernet_Address","label":"Terminal Ethernet Address"},{"item":"IP_Address","label":"IP Address"},{"item":"IP_Domain_Number","label":"IP Domain Number"}];
  ...
  exportToExcel(event:any) {
   ...
   this.excelService.download(dataArray,'export_pabx_tscIp_attendent');
  }
   ...
   this.fileList = event.target.files;
    ...
    import(){
      if (this.fileList.length > 0) {
        ...
        formData.append('module', "tsc_ip_attendent");
