...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxExternalLinesComponent } from './pabx-externalLines.component';
...
export const ROUTES: Routes = [
  { path: '', component: PabxExternalLinesComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxExternalLinesComponent,
    ExternalLinePipe
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxExternalLinesModule {}