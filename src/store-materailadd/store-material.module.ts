...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { StoreMaterialFormComponent } from './store-material.component';
...
export const ROUTES: Routes = [
  { path: '', component: StoreMaterialFormComponent }
];
...
@NgModule({
  ...
  declarations: [
    StoreMaterialFormComponent,
  ],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class StoreMaterialFormModule { }
