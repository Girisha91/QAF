...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { ExternalLinesRentComponent } from './externalLinesRent.component';
...
export const ROUTES: Routes = [
  { path: '', component: ExternalLinesRentComponent }
];
...
@NgModule({
  ...
  declarations: [
    ExternalLinesRentComponent,
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class ExternalLinesRentModule {}
