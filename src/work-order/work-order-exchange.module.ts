...
// containers
import { WorkOrderExchangeInfoComponent } from './work-order-form.exchange.component';
import { CommonModule } from '@angular/common';
// routes
export const ROUTES: Routes = [
  { path: '',component: WorkOrderExchangeInfoComponent },
];
...
@NgModule({
  ...
  declarations: [
    WorkOrderExchangeInfoComponent
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class WorkOrderFormExchangeModule {}