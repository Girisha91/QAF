...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxRoutingTableComponent } from './pabx-routingTable.component';
...
export const ROUTES: Routes = [
  { path: '', component: PabxRoutingTableComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxRoutingTableComponent
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxRoutingTableModule {}