...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { StoreItemListComponent } from './store-itemList.component';
import { StoreItemListSearchPipe } from '../app/storepipes/store.itemList.pipe';
import { FileUtil } from '../app/file.util';

import { CommonModule } from '@angular/common';
import { Ng2PaginationModule } from 'ng2-pagination';
export const ROUTES: Routes = [
  { path: '', component: StoreItemListComponent }
];
...
@NgModule({
  ...
  declarations: [
    ...
    StoreItemListSearchPipe
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class StoreItemListModule {}