...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxConfigurationInfoComponent } from './pabx-configurationInfo.component';
...
export const ROUTES: Routes = [
  { path: '', component: PabxConfigurationInfoComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxConfigurationInfoComponent,
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxConfigurationInfoModule {}