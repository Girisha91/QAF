...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { DemandBookFormComponent } from './demandBookForm.component';
...
export const ROUTES: Routes = [
  { path: '', component: DemandBookFormComponent }
];
...
@NgModule({
  ...
  declarations: [
    DemandBookFormComponent,
  ],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class DemandBookFormModule { }
