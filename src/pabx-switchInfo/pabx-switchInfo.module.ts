...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxSwitchInfoComponent } from './pabx-switchInfo.component';
...
export const ROUTES: Routes = [
  { path: '', component: PabxSwitchInfoComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxSwitchInfoComponent,
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxSwitchInfoModule {}