...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxFreeAddressComponent } from './pabx-freeAddress.component';
import { CommonModule } from '@angular/common';
import { Ng2PaginationModule } from 'ng2-pagination';
// routes
export const ROUTES: Routes = [
  { path: '', component: PabxFreeAddressComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxFreeAddressComponent,
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxFreeAddressModule {}