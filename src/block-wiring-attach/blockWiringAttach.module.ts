...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { blockWiringAttachComponent } from './blockWiringAttach.component';
...
export const ROUTES: Routes = [
  { path: '', component: blockWiringAttachComponent }
];
...
@NgModule({
  ...
  declarations: [
    blockWiringAttachComponent,
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class blockWiringAttachModule {}
