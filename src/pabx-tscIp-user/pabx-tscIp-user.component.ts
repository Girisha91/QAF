  ...
  @Component({
    moduleId: module.id,
    selector: 'app-pabx-tcsIp-user',
    templateUrl: './pabx-tscIp-user.component.html',
    styleUrls: [('./pabx-tscIp-user.component.css').toString()]
  })
  export class PabxTscIpUserComponent {
  ...
  self.EmployeeDetails = [];
    ...
    body.append('action',"tsp_ip_user");
  ...
  public searchKeyArray: any=[];
    loadData(){
      ...
      {"item":"Directory_Number","label":"Directory Number"},
      {"item":"Set_Type","label":"Set Type"},
      {"item":"Terminal_Ethernet_Address","label":"Terminal Ethernet Address"},
      {"item":"IP_Address","label":"IP Address"},
      {"item":"IP_Domain_Number","label":"IP Domain Number"},
      {"item":"IP_Softphone_Emulation","label":"IP Softphone Emulation"}];
  ...
  directorateSearch: any = '';
    ...
    exportToExcel(event:any) {
     ...
     this.excelService.download(dataArray,'export_pabx_tscIp_user');
    }
  ...
  import(){
    ...
    formData.append('module',"tsp_ip_user");
