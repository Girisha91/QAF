...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { PabxTscIpUserComponent } from './pabx-tscIp-user.component';
import { CommonModule } from '@angular/common';
import { Ng2PaginationModule } from 'ng2-pagination';
// routes
export const ROUTES: Routes = [
  { path: '', component: PabxTscIpUserComponent }
];
...
@NgModule({
  ...
  declarations: [
    PabxTscIpUserComponent
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class PabxTscIpUserModule {}