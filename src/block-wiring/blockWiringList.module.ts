...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { blockWiringListComponent } from './blockWiringList.component';
...
export const ROUTES: Routes = [
  { path: '', component: blockWiringListComponent }
];
...
@NgModule({
  ...
  declarations: [
    blockWiringListComponent,
  ],
  schemas: [ CUSTOM_ELEMENTS_SCHEMA],
})
export class blockWiringListModule {}