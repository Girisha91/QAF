...
//import { BsModalModule } from 'ng2-bs3-modal';
// containers
import { StoreItemFormComponent } from './storeItemForm.component';
...
export const ROUTES: Routes = [
  { path: '', component: StoreItemFormComponent }
];
...
@NgModule({
  imports: [
    ...
    HttpModule,
    SharedModule,
    BsModalModule,BsDatepickerModule,
...
export class StoreItemFormModule { }
